...
export function Footer() {
  ...
  return (
    <footer className="relative bg-obsidian text-charcoal overflow-hidden">
      ...
      <div className="relative container mx-auto px-4 md:px-6 py-16 md:py-20">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 md:gap-12">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="flex items-center gap-3 mt-6">
              <a
                ...
                className="w-10 h-10 rounded-full border border-charcoal/20 flex items-center justify-center text-charcoal/70 hover:text-champagne hover:border-champagne transition-all duration-300"
              >
            ...
            <ul className="space-y-3">
              {navLinks.map((link) => (
                <li key={link.key}>
                  <Link
                    href={link.href}
                    className="text-sm text-charcoal/60 hover:text-champagne transition-colors duration-300"
                  >
          ...
          <div className="lg:col-span-1">
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-center gap-3">
                ...
                <a href={`tel:${siteConfig.phone}`} className="text-sm text-charcoal/60 hover:text-champagne transition-colors" dir="ltr">
                  {siteConfig.phoneDisplay}
                </a>
              </li>
              <li className="flex items-center gap-3">
                <Mail className="h-4 w-4 text-champagne shrink-0" />
                <a href={`mailto:${siteConfig.email}`} className="text-sm text-charcoal/60 hover:text-champagne transition-colors">
                  {siteConfig.email}
                </a>
              </li>
            </ul>
          ...
          <div>
            ...
            <p className="text-sm text-charcoal/60 leading-relaxed mb-4">{t.contact.info.hours}</p>
            <Link
              href="/contact"
              className="inline-flex items-center gap-2 px-6 py-3 rounded-full bg-champagne text-warmwhite text-sm font-medium hover:bg-champagne-light transition-all duration-300 luxury-shadow"
            >
              {t.nav.quote}
            </Link>
          </div>
        ...
        {/* Bottom bar */}
        <div className="mt-16 pt-8 border-t border-charcoal/10 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-xs text-charcoal/40">
            &copy; {year} {t.brandName}. {t.footer.rights}
          </p>
          <div className="flex items-center gap-6">
            <span className="text-xs text-charcoal/40">{t.footer.madeWith}</span>
            <Link href="/contact" className="text-xs text-charcoal/40 hover:text-champagne transition-colors">
              {t.footer.privacy}
            </Link>
          </div>
        </div>
